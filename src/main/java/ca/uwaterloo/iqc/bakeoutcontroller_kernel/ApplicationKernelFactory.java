...
public final class ApplicationKernelFactory implements KernelFactory {
     ...
     */
    private ca.uwaterloo.iqc.bakeoutcontroller_kernel.Kernel kernelInstance;
     ...
     */
    @Override public ca.uwaterloo.iqc.bakeoutcontroller_kernel.Kernel getKernelInstance() throws
