...
import ca.uwaterloo.iqc.bakeoutcontroller_kernel.serial_ports.PortCommunicator;

import java.io.*;

/**
 * Base class for all ca.uwaterloo.iqc.bakeoutcontroller_kernel.devices using an RS232 serial port
 */
